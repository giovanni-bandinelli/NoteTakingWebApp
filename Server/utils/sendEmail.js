...
//I mean, how tf should i make it so that ${process.env.CLIENT_URL_DEV}/auth/reset-password/?token=${resetToken} or something else links to same email that im sending link to
  ...
  <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="text-align: center; padding: 20px;">
      ...
      <p style="font-size: 16px; color: #555;">
        We received a request to reset your password. A link, expiring in 3 hours, has been generated. Click the button below to proceed:
      </p>
